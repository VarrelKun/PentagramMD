...
let handler = async (m, { conn, args }) => {
	...
	let res = await fetch('https://api.lolhuman.xyz/api/nhentaipdf/'+ code )
	...
	conn.sendMessage(m.chat, { document: { url: 'https://api.lolhuman.xyz/api/nhentaipdf/'+ code }, jpegThumbnail, fileName: json.result.title + '.pdf', mimetype: 'application/pdf' }, { quoted: m })
}
